  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid tres mt--6">
      <div class="row ">
        <div class="col">
          <div class="card ">
			  <h1><center></br>Productos reservados</center></h1>
	   ...
	   $consultar1= mysqli_query($conn3 ,"SELECT a.Descripcion, a.Tipo_Activo, a.Imagenes, b.Fecha_Inicio, b.Documento FROM activo a INNER JOIN reserva_usuario b ON b.CodActivo = a.CodActivo where b.Documento = ".$_SESSION['documento']."  
	   limit $desde,$Paginas
	   ");
		  ...
		  echo "<thead class='thead-light'> ";
			...
			echo "</thead>";	
				while ($columna = mysqli_fetch_array($consultar1))
				{
					...
					echo "<td>" , $columna['Descripcion'] , "</td><td>" , $columna['Tipo_Activo'], "</td><td>" , $columna['Fecha_Inicio'],"</td><td class='imagen-producto'> <img src='$imagenes' alt='".$columna['Descripcion']."'>","</td>";
					echo "</tr>";
				}
