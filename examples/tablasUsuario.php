  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid tres mt--6">
      <div class="row ">
        <div class="col">
          <div class="card ">
			  <h1><center></br>Productos</center></h1>
	   ...
	   $consultar1= mysqli_query($conn3 ,"SELECT CodActivo, Descripcion, Valor_Activo,Cantidad,Fecha_Ingreso,Tipo_Activo,Imagenes FROM activo where Tipo_Activo = 'Microtecnologia' 
	   limit $desde,$Paginas
	   ");
		...
		echo "<table class='table' align=center>";
		  echo "<thead class='thead-light'> ";
			...
			echo "<th scope='col-auto' class='sort'>Cantidad Disponible</th>";
			...
			echo "</thead>";	
				while ($columna = mysqli_fetch_array($consultar1))
				{
					...
					echo "<td>" , $columna['Descripcion'] , "</td><td>" ,
						 $columna['Cantidad'] , "</td><td>" , $columna['Tipo_Activo'],"</td><td class='imagen-producto'> <img src='$imagenes' alt='".$columna['Descripcion']."'>","</td>";
					
					echo"<td>
					    <a  href='Reservaproducto.php?CodActivo=".$columna['CodActivo']."' class='edit'>Reservar</a>
					   </td>";
